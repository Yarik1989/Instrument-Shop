...
import com.epam.chuikov.form.ProductElementsOnPageMode;
import com.epam.chuikov.form.ProductFilterBean;
import com.epam.chuikov.form.ProductSortMode;
import com.epam.chuikov.listener.ContextListener;
...
public class ProductsServlet extends HttpServlet {
	...
	// Logger.getLogger(ProductsServlet.class);
	...
	public void init() throws ServletException {
		this.productsService = (ProductsService) getServletContext()
				.getAttribute(ContextListener.INIT_PRODUCTS_SERVICE_KEY);
	}
	...
	private ProductFilterBean extractProductFilter(HttpServletRequest request) {
		...
		String elementsOnPage = request.getParameter(FORM_ELEMENTS_ON_PAGE_PARAM);
		...
		String[] manufacturers = request.getParameterValues(FORM_MANUFACTURES_PARAM);
