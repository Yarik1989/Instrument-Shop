package com.epam.chuikov.shop.customtag;
...
import com.epam.chuikov.servlets.ProductsServlet;
...
public class PrepareUrlTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		if (filterBean.getPriceHigh() != null) {
			parts.add(ProductsServlet.FORM_PRICE_HIGH_PARAM + "=" + filterBean.getPriceHigh());
		}
		if (filterBean.getPriceLow() != null) {
			parts.add(ProductsServlet.FORM_PRICE_LOW_PARAM + "=" + filterBean.getPriceLow());
		}
		if (filterBean.getSortMode() != null) {
			parts.add(ProductsServlet.FORM_SORT_BY_PARAM + "=" + filterBean.getSortMode());
		}
		if (pageNum != null) {
