			...
			<div class="header-grid">
				...
				<div class="header-right1 ">
					<ul>
						...
						<li><i class="glyphicon glyphicon-book" ></i><a href="">Register</a></li>
					</ul>
				</div>
			...
			<div class="logo-nav">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Instrument<b class="caret"></b></a>
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Electro instrument</h6>
												<li><a href="products1.html">Perforator</a></li>
												<li><a href="products1.html">Grinding machines</a></li>
											</ul>
...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.html">Home</a><label>/</label>Products<label>/</label>Men's</h3>
		<div class="clearfix"> </div>
	</div>
</div>
	<!--content-->
			...
			<div class="sellers animated wow fadeInLeft" data-wow-delay=".5s">
					...
					<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.html"><img class="img-responsive " src="images/pcc2.jpg" alt=""></a>
							...
							<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.html"><img class="img-responsive " src="images/pcc3.jpg" alt=""></a>
							...
							<div class="grid-pro">
								<div  class=" grid-product " >
									<figure>		
										<a href="single.html">
											<div class="grid-img">
												<img  src="images/pr25.jpg" class="img-responsive" alt="">
											</div>
											<div class="grid-img">
												<img  src="images/pr24.jpg" class="img-responsive"  alt="">
											</div>			
										</a>		
									</figure>	
								</div>
							...
							<div class="grid-pro">
								<div  class=" grid-product " >
									<figure>		
										<a href="single.html">
											<div class="grid-img">
												<img  src="images/pr27.jpg" class="img-responsive" alt="">
											</div>
											<div class="grid-img">
												<img  src="images/pr26.jpg" class="img-responsive"  alt="">
											</div>			
										</a>		
									</figure>	
								</div>
							...
							<div class="grid-pro">
								<div  class=" grid-product " >
									<figure>		
										<a href="single.html">
											<div class="grid-img">
												<img  src="images/pr29.jpg" class="img-responsive" alt="">
											</div>
											<div class="grid-img">
												<img  src="images/pr28.jpg" class="img-responsive"  alt="">
											</div>			
										</a>		
									</figure>	
								</div>
